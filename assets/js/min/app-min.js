...
function h(e){return e.replace(Ie,"ms-").replace(He,o)}function s(){this.expando=Ce.expando+s.uid++}function r(e){return"true"===e||"false"!==e&&("null"===e?null:
...
function x(e,t){for(var n=0,i=e.length;n<i;n++)Ne.set(e[n],"globalEval",!t||Ne.get(t[n],"globalEval"))}function C(e,t,n,i,o){for(var s,r,a,l,u,c,d=t.createDocumentFragment(),f=[],h=0,p=e.length;h<p;h++)if((s=e[h])||0===s)
// Add nodes directly
if("object"===g(s))
...
if(p||1<d&&"string"==typeof h&&!ve.checkClone&&dt.test(h))return n.each(function(e){var t=n.eq(e);p&&(i[0]=h.call(this,e,t.html())),M(t,i,o,s)});if(d&&(t=(e=C(i,n[0].ownerDocument,!1,n,s)).firstChild,1===e.childNodes.length&&(e=t),t||s)){
// Use the original fragment for the last item
// instead of the first because it can end up
// being emptied incorrectly in certain situations (#8070).
for(a=(r=Ce.map(w(e,"script"),O)).length;c<d;c++)l=e,c!==f&&(l=Ce.clone(l,!0,!0),
...
Ce._evalUrl&&Ce._evalUrl(l.src):m(l.textContent.replace(ft,""),u,l))}return n}function L(e,t,n){for(var i,o=t?Ce.filter(t,e):e,s=0;null!=(i=o[s]);s++)n||1!==i.nodeType||Ce.cleanData(w(i)),i.parentNode&&(n&&Ce.contains(i.ownerDocument,i)&&x(w(i,"script")),i.parentNode.removeChild(i));return e}function A(e,t,n){var i,o,s,r,
// Support: Firefox 51+
...
return i}function V(e,t,n){var i,o,s,r,a,l,u,c,d="width"in t||"height"in t,f=this,h={},p=e.style,m=e.nodeType&&Xe(e),g=Ne.get(e,"fxshow");
// Queue-skipping animations hijack the fx hooks
// Detect show/hide animations
for(i in n.queue||(null==(r=Ce._queueHooks(e,"fx")).unqueued&&(r.unqueued=0,a=r.empty.fire,r.empty.fire=function(){r.unqueued||a()}),r.unqueued++,f.always(function(){
// Ensure the complete handler is called before this completes
f.always(function(){r.unqueued--,Ce.queue(e,"fx").length||r.empty.fire()})})),t)if(o=t[i],kt.test(o)){if(delete t[i],s=s||"toggle"===o,o===(m?"hide":"show")){
// Pretend to be hidden if this is a "show" and
// there is still data from a stopped show/hide
if("show"!==o||!g||void 0===g[i])continue;m=!0}h[i]=g&&g[i]||Ce.style(e,i)}
...
// Per-property setup
l=Y(m?g[i]:0,i,f),i in g||(g[i]=l.start,m&&(l.end=l.start,l.start=0))}function X(e,t){var n,i,o,s,r;
// camelCase, specialEasing and expand cssHook pass
for(n in e)if(o=t[i=h(n)],s=e[n],Array.isArray(s)&&(o=s[1],s=e[n]=s[0]),n!==i&&(e[i]=s,delete e[n]),(r=Ce.cssHooks[i])&&"expand"in r)
...
o[c]=r)[2]=a(e,t,n))return!0}return!1}}function f(o){return 1<o.length?function(e,t,n){for(var i=o.length;i--;)if(!o[i](e,t,n))return!1;return!0}:o[0]}function y(e,t,n){for(var i=0,o=t.length;i<o;i++)w(e,t[i],n);return n}function x(e,t,n,i,o){for(var s,r=[],a=0,l=e.length,u=null!=t;a<l;a++)(s=e[a])&&(n&&!n(s,i,o)||(r.push(s),u&&t.push(a)));return r}function b(h,p,m,g,v,e){return g&&!g[R]&&(g=b(g)),v&&!v[R]&&(v=b(v,e)),l(function(e,t,n,i){var o,s,r,a=[],l=[],u=t.length,
...
// Apply postFilter
if(m&&m(d,f,n,i),g)for(o=x(f,l),g(o,[],n,i),
...
}else f=x(f===t?f.splice(u,f.length):f),v?v(null,t,f,i):Z.apply(t,f)})}function m(e){for(var o,t,n,i=e.length,s=T.relative[e[0].type],r=s||T.relative[" "],a=s?1:0,
...
return o=null,i}];a<i;a++)if(t=T.relative[e[a].type])c=[d(f(c),t)];else{
// Return special upon seeing a positional matcher
if((t=T.filter[e[a].type].apply(null,e[a].matches))[R]){for(
// Find the next relative operator (if any) for proper handling
n=++a;n<i&&!T.relative[e[n].type];n++);return b(1<a&&f(c),1<a&&p(
// If the preceding token was a descendant combinator, insert an implicit any-element `*`
e.slice(0,a-1).concat({value:" "===e[a-2].type?"*":""})).replace(ae,"$1"),t,a<n&&m(e.slice(a,n)),n<i&&m(e=e.slice(n)),n<i&&p(e))}c.push(t)}return f(c)}function g(g,v){var y=0<v.length,b=0<g.length,e=function(e,t,n,i,o){var s,r,a,l=0,u="0",c=e&&[],d=[],f=O,
...
for(o&&(O=t===M||t||o);u!==m&&null!=(s=h[u]);u++){if(b&&s){for(r=0,t||s.ownerDocument===M||(P(s),n=!A);a=g[r++];)if(a(s,t||M,n)){i.push(s);break}o&&(F=p)}
...
return o&&(F=p,O=f),c};return y?l(e):e}var v,C,T,k,$,E,S,j,O,_,z,
// Local document vars
P,M,L,A,D,q,I,H,
...
type:i[0].replace(ae," ")}),r=r.slice(n.length)),T.filter)!(i=he[s].exec(r))||l[s]&&!(i=l[s](i))||(n=i.shift(),o.push({value:n,type:s,matches:i}),r=r.slice(n.length));if(!n)break}
...
for(o=he.needsContext.test(e)?0:s.length;o--&&(r=s[o],!T.relative[a=r.type]);)if((l=T.find[a])&&(i=l(r.matches[0].replace(be,we),ye.test(s[0].type)&&h(t.parentNode)||t))){if(
...
// Compile and execute a filtering function if one is not provided
// Provide `match` to avoid retokenization if we modified the selector above
return(u||S(e,c))(i,t,!A,n,!t||ye.test(e)&&h(t.parentNode)||t),n},
...
r[t]&&0===(i=r[t].name).indexOf("data-")&&(i=h(i.slice(5)),p(s,i,o[i]));Ne.set(s,"hasDataAttrs",!0)}return o},removeData:function(e){return this.each(function(){Fe.remove(this,e)})}}),Ce.extend({queue:function(e,t,n){var i;if(e)return t=(t||"fx")+"queue",i=Ne.get(e,t),
...
it.innerHTML="<textarea>x</textarea>",ve.noCloneChecked=!!it.cloneNode(!0).lastChild.defaultValue;var st=re.documentElement,rt=/^key/,at=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,lt=/^([^.]*)(?:\.(.+)|)/;Ce.event={global:{},add:function(t,e,n,i,o){var s,r,a,l,u,c,d,f,h,p,m,g=Ne.get(t);
...
c=Ce.extend({type:h,origType:m,data:i,handler:n,guid:n.guid,selector:o,needsContext:o&&Ce.expr.match.needsContext.test(o),namespace:p.join(".")},s),
...
if(h=m=(a=lt.exec(t[u])||[])[1],p=(a[2]||"").split(".").sort(),h){for(d=Ce.event.special[h]||{},f=l[h=(i?d.delegateType:d.bindType)||h]||[],a=a[2]&&new RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)"),
...
r&&!f.length&&(d.teardown&&!1!==d.teardown.call(e,p,g.handle)||Ce.removeEvent(e,h,g.handle),delete l[h])}else for(h in l)Ce.event.remove(e,h+t[u],n,i,!0);
...
dt=/checked\s*(?:[^=]|=\s*.checked.)/i,ft=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;Ce.extend({htmlPrefilter:function(e){return e.replace(ut,"<$1></$2>")},clone:function(e,t,n){var i,o,s,r,a=e.cloneNode(!0),l=Ce.contains(e.ownerDocument,e);
...
ve.focusin="onfocusin"in T;var Lt=/^(?:focusinfocus|focusoutblur)$/,At=function(e){e.stopPropagation()};Ce.extend(Ce.event,{trigger:function(e,t,n,i){var o,s,r,a,l,u,c,d,f=[n||re],h=pe.call(e,"type")?e.type:e,p=pe.call(e,"namespace")?e.namespace.split("."):[];
// Don't do events on text and comment nodes
if(s=d=r=n=n||re,3!==n.nodeType&&8!==n.nodeType&&!Lt.test(h+Ce.event.triggered)&&(-1<h.indexOf(".")&&(
...
c=Ce.event.special[h]||{},i||!c.trigger||!1!==c.trigger.apply(n,t))){
...
Ce.event.triggered=h,e.isPropagationStopped()&&d.addEventListener(h,At),n[h](),e.isPropagationStopped()&&d.removeEventListener(h,At),Ce.event.triggered=void 0,r&&(n[l]=r)),e.result}
...
// Timeout
g.async&&0<g.timeout&&(h=T.setTimeout(function(){C.abort("timeout")},g.timeout));try{p=!1,c.send(a,n)}catch(e){
...
Ce.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(e,t){Ce.fn[t]=function(e){return this.on(t,e)}}),Ce.expr.pseudos.animated=function(t){return Ce.grep(Ce.timers,function(e){return t===e.elem}).length},Ce.offset={setOffset:function(e,t,n){var i,o,s,r,a,l,u,c=Ce.css(e,"position"),d=Ce(e),f={};
...
t=t.call(e,n,Ce.extend({},a))),null!=t.top&&(f.top=t.top-a.top+r),null!=t.left&&(f.left=t.left-a.left+o),"using"in t?t.using.call(e,f):d.css(f)}},Ce.fn.extend({
...
return t=A(e,n),ht.test(t)?Ce(e).position()[n]+"px":t})}),
...
(o=function(){return e.apply(t||this,i.concat(le.call(arguments)))}).guid=e.guid=e.guid||Ce.guid++,o},Ce.holdReady=function(e){e?Ce.readyWait++:Ce.ready(!0)},Ce.isArray=Array.isArray,Ce.parseJSON=JSON.parse,Ce.nodeName=u,Ce.isFunction=ye,Ce.isWindow=be,Ce.camelCase=h,Ce.type=g,Ce.now=Date.now,Ce.isNumeric=function(e){
...
/* harmony import */var i=n(/*! jquery */"jquery"),c=/* */n.n(i),o=n(/*! ./foundation.core.utils */"./js/foundation.core.utils.js"),d=n(/*! ./foundation.util.mediaQuery */"./js/foundation.util.mediaQuery.js"),s,f={version:"6.5.1",
/**
...
// left aligned
h.a.extend(c,{next:l,previous:u,down:r,up:a}),g.Keyboard.handleKey(n,"DropdownMenu",c)})}
/**
     * Adds an event handler to the body to close any dropdowns on a click.
     * @function
     * @private
...
g=(100*T((h-f)*p,h)).toFixed(this.options.decimal);//fixing the decimal value for the location number, is passed to other methods as a fixed floating-point value
...
t.clientY===t.pageY&&(c+=h);var m=c-p,g,v=T(g=m<0?0:f<m?f:m,f),y,b;if(o=this._value(v),// turn everything around for RTL, yay math!
...
n.each(function(e,t){var n=h()(t),i=n.attr("aria-controls")||"",o;new RegExp("\\b".concat(Object(g.RegExpEscape)(s),"\\b")).test(i)||n.attr("aria-controls",i?"".concat(i," ").concat(s):s)})}
/**
...
if(this.removeEventListener("touchmove",a),this.removeEventListener("touchend",r),!w){var t=f.a.Event("tap",y||e);f()(this).trigger(t)}y=null,w=b=!1}function a(e){if(f.a.spotSwipe.preventDefault&&e.preventDefault(),b){var t=e.touches[0].pageX,n=e.touches[0].pageY,i=p-t,o=m-n,s;w=!0,v=(new Date).getTime()-g,Math.abs(i)>=f.a.spotSwipe.moveThreshold&&v<=f.a.spotSwipe.timeThreshold&&(s=0<i?"left":"right"),// else if(Math.abs(dy) >= $.spotSwipe.moveThreshold && elapsedTime <= $.spotSwipe.timeThreshold) {
//   dir = dy > 0 ? 'down' : 'up';
// }
s&&(e.preventDefault(),r.apply(this,arguments),f()(this).trigger(f.a.Event("swipe",e),s).trigger(f.a.Event("swipe".concat(s),e)))}}function l(e){1==e.touches.length&&(p=e.touches[0].pageX,m=e.touches[0].pageY,y=e,w=!(b=!0),g=(new Date).getTime(),this.addEventListener("touchmove",a,!1),this.addEventListener("touchend",r,!1))}function u(){this.addEventListener&&this.addEventListener("touchstart",l,!1)}function c(){this.removeEventListener("touchstart",l)}n.r(t),
/* harmony export (binding) */n.d(t,"Touch",function(){return h});
/* harmony import */var d=n(/*! jquery */"jquery"),f=/* */n.n(d),h={},p,m,g,v,y,b=!1,w=!1,x=
/* */
...
e(require("jquery")):
// Browser globals
e(jQuery)}(function(f){function h(e){return v.raw?e:encodeURIComponent(e)}function p(e){return v.raw?e:decodeURIComponent(e)}function m(e){return h(v.json?JSON.stringify(e):String(e))}function i(e){0===e.indexOf('"')&&(
// This is a quoted cookie as according to RFC2068, unescape...
e=e.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{
// Replace server-side written pluses with spaces.
// If we can't decode the cookie, ignore it, it's unusable.
// If we can't parse the cookie, ignore it, it's unusable.
return e=decodeURIComponent(e.replace(t," ")),v.json?JSON.parse(e):e}catch(e){}}function g(e,t){var n=v.raw?e:i(e);return f.isFunction(t)?t(n):n}var t=/\+/g,v=f.cookie=function(e,t,n){
// Write
if(void 0!==t&&!f.isFunction(t)){if("number"==typeof(n=f.extend({},v.defaults,n)).expires){var i=n.expires,o=n.expires=new Date;o.setTime(+o+864e5*i)}return document.cookie=[h(e),"=",m(t),n.expires?"; expires="+n.expires.toUTCString():"",// use expires attribute, max-age is not supported by IE
...
e||void 0===(d=g(d))||(s[c]=d)}return s};v.defaults={},f.removeCookie=function(e,t){return void 0!==f.cookie(e)&&(
// Must not alter options, thus extending a fresh object...
f.cookie(e,"",f.extend({},t,{expires:-1})),!f.cookie(e))}}),$(document).ready(function(){function e(){
// Foundation
// ----------
